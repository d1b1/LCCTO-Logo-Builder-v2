  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Low Code CTO: Icon Logo Builder</h1>
          <p className="text-gray-600">Create a 2x2 grid logo with Font Awesome icons. Uses an Algolia search to find icons.</p>
        </div>
